...
# Find the GameStop revenue table (index 1)
...
def make_graph(stock_data, revenue_data, stock):
    ...
    # Add Revenue trace (right y-axis)
    fig.add_trace(
    ...
    fig.update_layout(
        title_text=f"{stock} Stock Price vs Revenue (through June 2021)",
        legend=dict(x=0.1, y=1.1, orientation="h")
    )

    fig.show()

# Filter your tesla_data up to June 2021 if you haven't already:
...
# Filter your gme_data up to June 2021 if you haven't already:
